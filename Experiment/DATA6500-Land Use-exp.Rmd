...
toronto_area <- opq(bbox=toronto_bbox) |> 
...
toronto_area = st_transform(toronto_area, crs = 3979)
```
...
tm_shape(toronto_area_2010_masked) +
  ...
  tm_layout(title = "Land Coverage of Toronto 2010",legend.outside = TRUE)
```
...
color_palette_2015 <-  c("#e60049", "#0bb4ff", "#50e991", "#e6d800", "#9b19f5", "#ffa300", "#dc0ab4", "#b3d4ff", "#00bfa0")

#Plotting the 2015 land coverage data for ontario 
tm_shape(land_coverage_2015_cropped) +
  tm_raster(palette = color_palette_2015) +
  tm_shape(toronto_area) +
  tm_borders(col = "blue", lwd = 2) +
...
tm_shape(toronto_area_2015_masked) +
  ...
  tm_shape(toronto_area) +
  tm_borders(col = "blue", lwd = 2) +
  tm_layout(title = "Land Coverage of Toronto 2015",legend.outside = TRUE)
```
